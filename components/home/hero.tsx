        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <Badge variant="secondary" className="inline-flex items-center gap-2 px-4 py-2 text-sm bg-rose-50 text-rose-700 border-rose-200 dark:bg-rose-950 dark:text-rose-300 dark:border-rose-800">
              ...
              <div className="flex items-center justify-center">
                <a href="/services">
                  <div className="group cursor-pointer border border-border bg-card gap-2 h-[60px] flex items-center p-[10px] rounded-full">
                    <div className="border border-border bg-gradient-to-r from-rose-500 to-orange-500 h-[40px] rounded-full flex items-center justify-center text-white">
          ...
          >
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-2">Powered by cutting-edge AI technology</p>
            </div>
          </motion.div>
        </div>
      </section>
